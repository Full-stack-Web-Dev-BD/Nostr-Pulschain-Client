...
const ChannelListItem = (props: { c: Channel }) => {
    ...
    const isSelected = c.id === channel?.id && location.pathname.startsWith('/home/');

    return <ListItem key={c.id} label={c.name} href={`/home`} selected={isSelected} hasUnread={hasUnread}/>;
}
