...
const ProposalChatInput = (props: { separator: string, senderFn: (message: string, mentions: string[]) => Promise<any> }) => {
    ...
    return <Box sx={{
        ...
        <Box sx={{
            ...
            <Box sx={{ p: '1px 10px' }}>
                <p style={{paddingTop:'10px'}}> <span> <FaArrowDown/> </span> Share  your thought about this Proposal </p>
                <EditorContent
                    editor={editor}
                    onKeyDown={(e) => {
