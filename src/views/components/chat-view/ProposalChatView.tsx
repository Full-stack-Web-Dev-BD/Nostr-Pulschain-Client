...
import ProposalMessageView from '../message-view/ProposalMessageView';

const ProposalChatView = (props: { messages: Message[], separator: string, loading?: boolean, isDM?: boolean }) => {
        ...
        {messages.map((msg, i) => {
            ...
            if (msgDate !== prevMsgDate) {
                return <React.Fragment key={msg.id}>
                    ...
                    <ProposalMessageView message={msg} dateFormat='time' compactView={isCompact}/>
                </React.Fragment>
            }

            return <ProposalMessageView key={msg.id} message={msg} dateFormat='time' compactView={isCompact}/>;
        })}
